module Compile where -- (compileToBASH, compileToC, compileToJS, compileToFileWith) where
...
-- type CompileResult = Error LanguageError [String]
--
...
--     , "" ]
--
-- compileBlockToC :: Block -> CompileResult
-- compileBlockToC (Block xs) = concat $ map (compileStatementToC) xs
--
-- compileStatementToC :: Statement -> CompileResult
